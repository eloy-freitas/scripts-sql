...
values(2, 'chubscreuza', current_date, 'raimunda', 'chubscreuza@ufes.br', '14134778923', 1);

insert into dependentes(id_colaborador_fk, nome, data_nascimento, nome_mae, email, cpf, id_relacao_parental_fk)
values(3, 'bruno', current_date, 'kiko', 'bruno@ufes.br', '14134778926', 2);

insert into dependentes(id_colaborador_fk, nome, data_nascimento, nome_mae, email, cpf, id_relacao_parental_fk)
values(4, 'marcilio', current_date, 'o loko', 'marcilio@ufes.br', '14134758926', 2)