...
insert into
	colaborador (nome, etnia, uf_naturalidade,genero, estado_civil,	data_nascimento, cpf_cnpj, nome_mae,
...
insert into
	colaborador (nome, etnia, uf_naturalidade,genero, estado_civil,	data_nascimento, cpf_cnpj, nome_mae,
	nome_pai, data_admissao, cargo, salario, vale_transporte, id_tipo_contrato_fk, id_tipo_ticket_fk)
values('molgol gigante'. 'branco', 'ES', 'vitória', 'duvidoso', 'aberto', '1998-4-24', '12345678911',
'dadawqe', 'adasdsca'. '2021-03-17', 'vendedor', 100, 400, 3, 3);

insert into
	colaborador (nome, etnia, uf_naturalidade,genero, estado_civil,	data_nascimento, cpf_cnpj, nome_mae,
	nome_pai, data_admissao, cargo, salario, vale_transporte, id_tipo_contrato_fk, id_tipo_ticket_fk)
values('molgol de franja'. 'branco', 'ES', 'vitória', 'duvidoso', 'aberto', '1998-4-24', '12345678911',
